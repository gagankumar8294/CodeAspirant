...
import sakshiDay1 from './SakshiDate/23-09-23';
import sakshiDay2 from './SakshiDate/24-09-23';

const sakshiDatesComponent = () => {
  ...
  const renderContent = (date) => {
    if (selectedDate !== null && selectedDate === date) {
      return (
        <div>
          {date === '24_09_23' && <sakshiDay2 />}
          {date === '23_09_23' && <sakshiDay1 />}
        </div>
      );
    }
    return null;
...
export default sakshiDatesComponent;