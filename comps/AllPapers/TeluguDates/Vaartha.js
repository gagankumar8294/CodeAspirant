...
import VaarthaDay1 from './VaarthaDate/23-09-23';
import VaarthaDay2 from './VaarthaDate/24-09-23';

const VaarthaDatesComponent = () => {
  ...
  const renderContent = (date) => {
    if (selectedDate !== null && selectedDate === date) {
      return (
        <div>
          {date === '24_09_23' && <VaarthaDay2 />}
          {date === '23_09_23' && <VaarthaDay1 />}
        </div>
      );
    }
    return null;
...
export default VaarthaDatesComponent;