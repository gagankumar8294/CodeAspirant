...
import EenaduDay1 from './EenaduDate/23-09-23';
import EenaduDay2 from './EenaduDate/24-09-23';

const EenaduDatesComponent = () => {
  ...
  const renderContent = (date) => {
    if (selectedDate !== null && selectedDate === date) {
      return (
        <div>
          {date === '24_09_23' && <EenaduDay2 />}
          {date === '23_09_23' && <EenaduDay1 />}
        </div>
      );
    }
    return null;
...
export default EenaduDatesComponent;