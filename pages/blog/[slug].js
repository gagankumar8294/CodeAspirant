...
const BlogDetail = () => {
  ...
  <div className={styles.social}>
    <ul>
      ...
      <li>
        <a href={`whatsapp://send?text=Check out this amazing blog post:%0A${encodeURIComponent(blogTitle)}%0A${encodeURIComponent(blogURL)}`} target="_blank" rel="noopener noreferrer">
          <svg className={styles.svg} version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
